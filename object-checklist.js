...
const student = {
    id: 101,
    name: 'Protik',
    profession: {job: 'student', schoolName: 'OIS', address: 'Tarail'},
...
const work = `${student.profession.job}`;
// console.log(work);
const subject = `${student.subjects[1]}`;
// console.log(subject);
// const exam = `${student.takeExam()}`;

//৩.১. শূন্য প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন লিখবে যেটা ৮৯ রিটার্ন করবে। 

const sum = () => console.log(89) ;
// sum();
...
const result = (num1, num2) => {
    const addNum1 = num1 + 7;
    const addNum2 = num2 + 7;
...
const numbers = [7, 14, 21, 28, 35, 42, 49];
const output = numbers.map(num => num/7);
// console.log(output);
...
const {job, schoolName} = student.profession;
const {subjects} = student;
// console.log(job, schoolName);
